...
def generate_markdown_report(
    ...
    lines = [
        ...
        "## Executive Summary",
        "",
        f"The CxT (Contextual xT) model predicts expected threat value for ball progression actions ",
        f"(passes, carries, dribbles), adjusted for opponent defensive quality and game context.",
        "",
        "### Key Results",
        "",
        f"| Metric | Value |",
