"""Train an assist-quality uplift model."""
...
BUCKET_COL = "assist_bucket"
BUCKET_FEATURE = "assist_encoder"
NUMERIC_FEATURES = ["statsbomb_xg"]
GROUP_COLS = ["assist_category", "pass_style", "pressure_state"]
MIN_SHOTS = 25
...
def main() -> None:
    ...
    model_path = out_dir / "assist_quality_model.joblib"
    metrics_path = out_dir / "assist_quality_model_metrics.json"
    summary_path = out_dir / "assist_quality_modeled.csv"
