...
prepare-cxa-plus-feature-contract:  ## Prepare first governed CxA+ modelling feature contract (no training)
	poetry run python scripts/prepare_cxa_plus_feature_contract.py
